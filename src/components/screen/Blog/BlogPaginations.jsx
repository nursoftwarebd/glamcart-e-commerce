  ...
  return (
    <div className="pt-13 flex items-center justify-center">
      <div className="flex items-center gap-2 sm:gap-[14px]">
        <button className="w-8 sm:w-12 h-[35.25px] flex items-center justify-center border-[.5px] rounded-sm border-grayBorderPage bg-white">
          <Image src={arrowPage} alt="arrowPage" />
        </button>
        <button className="w-8 sm:w-[41px] h-[35px] flex items-center justify-center border-[.5px] rounded-sm  border-grayBorderPage bg-primary text-white">
          <span className="text-lg leading-[27px] font-medium">1</span>
        </button>
        <button className="w-8 sm:w-[41px] h-[35px] flex items-center justify-center border-[.5px] rounded-sm  border-grayBorderPage bg-white text-grayView">
        ...
        <button className="w-8 sm:w-[39px] h-[35px] flex items-center justify-center border-[.5px] rounded-sm  border-grayBorderPage bg-white text-grayView">
